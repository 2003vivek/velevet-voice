...
$sql="SELECT * FROM chatlogin";
$res=mysqli_query($conn,$sql);
$num=mysqli_num_rows($res);

$rand="SELECT * FROM chatlogin ORDER BY RAND() LIMIT 12";
...
$clicked_name=$_GET['name'];
if(!isset($_GET['name']))
{
    echo "please choose somebody";

}

if($_SERVER['REQUEST_METHOD']=="POST"){
    $chatinp=$_POST['chatinput'];
    $nam=$_SESSION['name'];

    $q="INSERT INTO chatting_input(`input`,`name`) VALUES('$chatinp','$nam')";
    $ress=mysqli_query($conn,$q);
}
$sess_name=$_SESSION['name'];

$q2="SELECT * FROM chatting_input WHERE `name`='$clicked_name'";
$input_res=mysqli_query($conn,$q2);

$num_input=mysqli_num_rows($input_res);
// while($rows=mysqli_fetch_assoc($input_res)){
//     $chat_inputs[]=$rows['input'];
// }
    ...
    <div class="layout-wrapper d-lg-flex">
        ...
        <div class="side-menu flex-lg-column me-lg-1 ms-lg-0">
            ...
            <div class="navbar-brand-box">
                <a href="index-dark.php" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="assets/images/faviconn.ico" alt="Unable to load Server error!!!" height="36">
                        </span>
                    </a>

                <a href="index.html" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="assets/images/faviconn.ico" alt="" height="30">
                        </span>
                    </a>
            </div>
                ...
                <ul class="nav nav-pills side-menu-nav justify-content-center" role="tablist">
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Profile">
                       <a  class="nav-link" id="pills-user-tab" data-bs-toggle="pill" href="#pills-user" role="tab">
                                ...
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQL1r6AVyUAdrRqPonQh7qMsP5AB4hCdweYDQ&usqp=CAU" width="35px">
                    ...
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Chats">
                        ...
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyVhbQd_4RuHNuLtTLbJAlfj5TulIRiQEYIw&usqp=CAU" width="35px">
                    ...
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Settings">
                        ...
                        <img src="https://i.pinimg.com/474x/6e/9e/ef/6e9eefe667353989fe67f1862bb64da6.jpg" width="35px">
            ...
            <div class="flex-lg-column d-none d-lg-block">
                <ul class="nav side-menu-nav justify-content-center">
                    <li class="nav-item">
                        ...
                        <img src="https://cdn-icons-png.flaticon.com/128/42/42146.png" width="33px">
                ...
                <div class="tab-pane" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
                    ...
                    <div>
                        ...
                        <div class="text-center p-4 border-bottom">
                            ...
                            <h5 class="font-size-16 mb-1 text-truncate">'.$_SESSION['name'].'</h5>
                        ...
                        <div class="p-4 user-profile-desc" data-simplebar>
                            <div class="text-muted">
                                <p class="mb-4">This is Your Personal Profile Area.</p>
                            </div>
                                    ...
                                    <div id="about" class="accordion-collapse collapse show" aria-labelledby="about2" data-bs-parent="#tabprofile">
                                        <div class="accordion-body">
                                            <div>
                                                ...
                                                <h5 class="font-size-14">'.$_SESSION['name'].'</h5>
                                            </div>

                                            <div class="mt-4">
                                                <p class="text-muted mb-1">Email</p>
                                                <h5 class="font-size-14">'.$_SESSION['email'].'</h5>
                                            </div>

                                            <div class="mt-4">
                                                <p class="text-muted mb-1">Created on</p>
                                                <h5 class="font-size-14">'.$_SESSION['date_time'].'</h5>
                                            </div>

                                            <div class="mt-4">
                                                <p class="text-muted mb-1">Location</p>
                                                <h5 class="font-size-14 mb-0">'.$_SESSION['country'].' , '. $_SESSION['city'].'</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <a href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">patrick</h5>
                ...
                <!-- End chats tab-pane -->
                        ...
                        <div class="">
                            ...
                            <div class="chat-message-list px-2" data-simplebar>
                                ...
                                <ul class="list-unstyled chat-list chat-user-list">
                                    <li>
                                        <a href="index-dark.php?name='.$names[0].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img online align-self-center me-3 ms-0">
                                                    <img src="assets/images/users/avatar-2.jpg" class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[0].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0">Hey! there I m available</p>
                                                </div>
                                                <div class="font-size-11">05 min</div>
                                            </div>
                                    ...
                                    <li class="unread">
                                        <a href="index-dark.php?name='.$names[1].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img away align-self-center me-3 ms-0">
                                                    <img src="assets/images/users/avatar-3.jpg" class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[1].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0"><i class="ri-image-fill align-middle me-1 ms-0"></i> Images</p>
                                                </div>
                                                <div class="font-size-11">12 min</div>
                                                <div class="unread-message">
                                    ...
                                    <li>
                                        <a href="index-dark.php?name='.$names[2].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img align-self-center me-3 ms-0">
                                                    <div class="avatar-xs">
                                                        <span class="avatar-title rounded-circle bg-primary-subtle text-primary">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[2].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0">This theme is awesome!</p>
                                                </div>
                                                <div class="font-size-11">20 min</div>
                                            </div>
                                    ...
                                    <li class="active">
                                        <a href="index-dark.php?name='.$names[3].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img online align-self-center me-3 ms-0">
                                                    <img src="assets/images/users/avatar-4.jpg" class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[3].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0">Nice to meet you</p>
                                                </div>
                                                <div class="font-size-11">10:12 AM</div>
                                            </div>
                                    ...
                                    <li class="unread">
                                        <a href="index-dark.php?name='.$names[4].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img align-self-center me-3 ms-0">
                                                    <div class="avatar-xs">
                                                        <span class="avatar-title rounded-circle bg-primary-subtle text-primary">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[4].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0">Next meeting tomorrow 10.00AM</p>
                                                </div>
                                                <div class="font-size-11">12:01 PM</div>
                                                <div class="unread-message">
                                    ...
                                    <li>
                                        <a href="index-dark.php?name='.$names[5].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img away align-self-center me-3 ms-0">
                                                    <img src="assets/images/users/avatar-6.jpg" class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[5].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0"><i class="ri-file-text-fill align-middle me-1 ms-0"></i> Admin-A.zip</p>
                                                </div>
                                                <div class="font-size-11">03:20 PM</div>
                                            </div>
                                    ...
                                    <li class="typing">
                                        <a href="index-dark.php?name='.$names[6].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img align-self-center online me-3 ms-0">
                                                    <div class="avatar-xs">
                                                        <span class="avatar-title rounded-circle bg-primary-subtle text-primary">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[6].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0">typing<span class="animate-typing">
                                                            <span class="dot"></span>
                                                        <span class="dot"></span>
                                                        <span class="dot"></span>
                                    ...
                                    <li>
                                        <a href="index-dark.php?name='.$names[7].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img align-self-center online me-3 ms-0">
                                                    <div class="avatar-xs">
                                                        <span class="avatar-title rounded-circle bg-primary-subtle text-primary">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[7].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0">Yeah everything is fine</p>
                                                </div>
                                                <div class="font-size-11">12/07</div>
                                            </div>
                                    ...
                                    <li>
                                        <a href="index-dark.php?name='.$names[8].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img away align-self-center me-3 ms-0">
                                                    <img src="assets/images/users/avatar-7.jpg" class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[8].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0">Good morning</p>
                                                </div>
                                                <div class="font-size-11">12/07</div>
                                            </div>
                                    ...
                                    <li>
                                        <a href="index-dark.php?name='.$names[9].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img align-self-center online me-3 ms-0">
                                                    <div class="avatar-xs">
                                                        <span class="avatar-title rounded-circle bg-primary-subtle text-primary">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[9].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0">Hi, How are you?</p>
                                                </div>
                                                <div class="font-size-11">12/07</div>
                                            </div>
                                    ...
                                    <li>
                                        <a href="index-dark.php?name='.$names[10].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img away align-self-center me-3 ms-0">
                                                    <img src="assets/images/users/avatar-8.jpg" class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[10].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0">I ve finished it! See you so</p>
                                                </div>
                                                <div class="font-size-11">11/07</div>
                                            </div>
                                    ...
                                    <li>
                                        <a href="index-dark.php?name='.$names[11].'">
                                            <div class="d-flex">
                                                <div class="chat-user-img align-self-center online me-3 ms-0">
                                                    <div class="avatar-xs">
                                                        <span class="avatar-title rounded-circle bg-primary-subtle text-primary">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate font-size-15 mb-1">'.$names[11].'</h5>
                                                    <p class="chat-user-message text-truncate mb-0">Wow that"s great</p>
                                                </div>
                                                <div class="font-size-11">11/07</div>
                                            </div>
                    ...
                    <div>
                        ...
                        <div class="text-center border-bottom p-4">
                            <div class="mb-4 profile-user">
                                <img src="assets/images/users/avatar-1.jpg" class="rounded-circle avatar-lg img-thumbnail" alt=" unable to load">
                                    ...
                                    <div id="personalinfo" class="accordion-collapse collapse show" aria-labelledby="personalinfo1" data-bs-parent="#settingprofile">
                                        <div class="accordion-body">
                                            <div class="float-end">
                                                ...
                                                <a href="/CHATAPPLICATION/preview.colorlib.com\theme\bootstrap\login-form-20\edit_profile.php">
                                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScibtu8kbZE5z-l85PuH45CbjWyyDxDJz82g&usqp=CAU" width="30px" height="29px" ></a>
                                                <!--<i class="ri-edit-fill me-1 ms-0 align-middle"></i>--> </button>
                                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-4 col-8">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="me-3 ms-0">
<!-----------------------------------><img src="assets/images/users/avatar-4.jpg" class="rounded-circle avatar-xs" alt="Unable to load">
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-16 mb-0 text-truncate"><a href="#" class="text-reset user-profile-show">'.$clicked_name.'</a> <!--<i class="ri-record-circle-fill font-size-10 text-success d-inline-block ms-1"></i>--></h5>
                                    </div>
                                </div>
                            </div>
                    ...
                    echo '
                                    ...
                                    <div class="user-chat-content">
                                        ...
                                        <div class="conversation-name">'.$rows['name'].'</div>
                                    </div>
                                </div>
                            </li>';}}
                            ?>
                    ...
                    <div class="chat-input-section p-3 p-lg-4 border-top mb-0 bottom-fixed">

                        <div class="row g-0">

                            <div class="col">
                            <?php
                            echo '<form action="index-dark.php?name='.$clicked_name.'" method="post">';?>
                                <input type="text" class="form-control form-control-lg bg-light border-dark bottom-fixed" name="chatinput" placeholder="Enter Message...">
                            ...
                            <div class="col-auto">
                                <div class="chat-input-links ms-md-2 me-md-0">
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <?php
                                            echo '<button type="submit" href="index-dark.php?name='.$clicked_name.'" class="btn btn-primary font-size-1 btn-lg chat-send waves-effect waves-light">';
                                            ?>
                                            <img src="https://png.pngtree.com/png-vector/20210701/ourmid/pngtree-send-button-for-social-media-apps-with-circle-background-png-image_3549907.jpg" width="30px"  >
